...
const NutritionPage = ({ supplements, poids, onSupplementAdded }) => {
  ...
  const activityMultipliers = {
    sedentaire: { label: 'Sedentaire (bureau)', value: 1.2 },
    leger: { label: 'Leger (1-2x/sem)', value: 1.375 },
    modere: { label: 'Modere (3-5x/sem)', value: 1.55 },
    actif: { label: 'Actif (6-7x/sem)', value: 1.725 },
    tres_actif: { label: 'Tres actif (2x/jour)', value: 1.9 }
  };
      ...
      <div style={cardStyle}>
        ...
        <div className="tdee-inputs-grid">
          <div>
            ...
            {!dernierPoids && <span style={{ fontSize: '11px', color: '#999' }}>Aucune mesure (defaut: 80kg)</span>}
          </div>
          <div>
          ...
          <div className="span-2">
            <label style={{ fontSize: '13px', color: '#555', display: 'block', marginBottom: '4px' }}>Niveau d'activite</label>
            <select
        ...
        <div style={{ backgroundColor: '#f8f9fa', borderRadius: '8px', padding: '16px' }}>
          <div className="tdee-results">
            ...
            <div className="tdee-result-card" style={{ backgroundColor: '#fff3e0', border: '1px solid #ffcc80' }}>
              <div style={{ fontSize: '12px', color: '#e65100' }}>Deficit -300</div>
            ...
            <div className="tdee-result-card" style={{ backgroundColor: '#fce4ec', border: '1px solid #ef9a9a' }}>
              <div style={{ fontSize: '12px', color: '#c62828' }}>Deficit -500</div>
          ...
          <h4 style={{ margin: '0 0 12px 0', color: '#444' }}>Repartition macros suggeree</h4>
          ...
          <MacroBar label="Deficit -300" prot={tdee.macros.deficit300.prot} gluc={tdee.macros.deficit300.gluc} lip={tdee.macros.deficit300.lip} total={tdee.deficit300} />
          <MacroBar label="Deficit -500" prot={tdee.macros.deficit500.prot} gluc={tdee.macros.deficit500.gluc} lip={tdee.macros.deficit500.lip} total={tdee.deficit500} />
        </div>
      </div>

      {/* Supplements */}
      <div style={cardStyle}>
        <h2 style={{ margin: '0 0 16px 0', color: '#333', fontSize: '20px' }}>Supplements</h2>
        <SupplementsForm onSupplementAdded={onSupplementAdded} />

        {activeSupplements.length > 0 && (
          <div style={{ marginTop: '16px' }}>
            <h3 style={{ fontSize: '15px', color: '#555', marginBottom: '8px' }}>Supplements actifs</h3>
